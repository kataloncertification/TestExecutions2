...
//WS.getResponseStatusCode(findTestObject('Object Repository/GET user by id'))
def iresp=WS.sendRequest(findTestObject('Object Repository/GET user by id'))

WS.getResponseStatusCode(iresp)

println(WS.getResponseStatusCode(iresp))
WebUI.closeBrowser()
