...
WebUI.waitForPageLoad(100)
WebUI.takeElementScreenshotAsCheckpoint("Admin Module", findTestObject('Object Repository/Page_OrangeHRM/span_Admin'))
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_Admin'))
WebUI.maximizeWindow()
WebUI.waitForPageLoad(100)
WebUI.takeScreenshotAsCheckpoint("Admin module checkpoint")
WebUI.delay(5)
WebUI.waitForPageLoad(100)
