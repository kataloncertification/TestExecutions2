...
WebUI.sendKeys(findTestObject('Object Repository/Page_OrangeHRM/button_Confirm'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Employee Full Name_firstName'), '1')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Past EmployeeInvalid'))
